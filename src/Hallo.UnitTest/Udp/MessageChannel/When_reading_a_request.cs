...
{
    [TestFixture]
    public class When_reading_a_request : UdpMessageBaseSpecification
    {
        ...
        [Test]
        public void Expect_the_Message_is_of_type_request()
        {
            Result.Message.Should().BeOfType<SipRequest>();
        }
