...
{
    public class When_in_completed_state_a_provisional_response_is_send : TxSpecificationBase
    {
        private SipResponse _response;
        private SipResponse _mostRecentResponse;

        public When_in_completed_state_a_provisional_response_is_send()
            : base()
        {
        ...
        {
            _mostRecentResponse = CreateProvisionalResponse();
        ...
        [Test]
        public void Expect_the_stx_to_stay_in_completed_state()
        {
