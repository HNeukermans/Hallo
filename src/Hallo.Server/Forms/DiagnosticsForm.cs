...
{
    public partial class DiagnosticsForm : ServerChildForm
    {
        ...
        {
            _tmrRefresh.Start();
            _usageThreadsInPool.Maximum = MainForm.Configuration.MaxThreadPoolSize;
        }
        ...
        private void _tmrRefresh_Tick(object sender, EventArgs e)
        {
            ...
            var info = Server.GetDiagnosticsInfo();
            ...
            _lblMaxExecTime.Text = info.MaximumExecutionTime.TotalMilliseconds.ToString();
            _lblMaxQueueTime.Text = info.MaximumQueueWaitTime.TotalMilliseconds.ToString();
            _lblAvgExecTime.Text = info.AvgExecutionTime.TotalMilliseconds.ToString();
