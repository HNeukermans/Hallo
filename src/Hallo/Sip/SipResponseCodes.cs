namespace Hallo.Sip
{
    public class SipResponseCodes
    {
        ...
        public static readonly string x400_Bad_Request_InvalidCseqMethod = x400_Bad_Request + ": CSeq method differs from requestline method.";

        public static readonly string x400_Bad_Request_UnsupportedSipVersion = x400_Bad_Request + ": Sipversion is not supported.";

        public static readonly string x400_Bad_Request_HasMissingHeaderField_FormatString = x400_Bad_Request + ": Missing '{0}' header.";
