...
//Security restriction in Silverlight prevents getting private properties and fields
        ...
        {
            IPEndPoint ep1 = object1 as IPEndPoint;
            IPEndPoint ep2 = object2 as IPEndPoint;

            if (ep1 == null) //This should never happen, null check happens one level up
                throw new ArgumentNullException("object1");

            if (ep2 == null) //This should never happen, null check happens one level up
            ...
            CompareSimpleType(ep1.Port, ep2.Port, breadCrumb);
        }

        private bool IsIpEndPoint(Type t1)
        {
            return (typeof(IPEndPoint).IsAssignableFrom(t1));
        }
